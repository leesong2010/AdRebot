...
public class QuMiApp extends Application {
	public static List<ActiveLog> appList = new ArrayList<ActiveLog>();
	public final static String TAG = "qumi";
	public final static String ACTIVE_NAME = "qumi";
	...
	public final static String SERVER_URL = "http://42.51.15.134:8080/adrobot-web";
