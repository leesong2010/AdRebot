...
class Download extends Observable{
    ...
    public Download(URL url,String UA,boolean trueDown) {
        this.url = url;
        size = -1;
        downloaded = 0;
        status = DOWNLOADING;
    ...
    public String toDownload() throws Exception
    {
        ...
        try {
            ...
            connection.setRequestProperty("Host", "ts.sogo.wuquad.com");
         ...
         //   cancel();
            ...
            //file = new RandomAccessFile(DJContext.FILESAVEPATH + getFileName(url), "rw");
                ...
                int minSpeed = 550;
                int maxSpeed = 1200;
                int downSpeed = getRangeRandomNum(minSpeed, maxSpeed);
